...
__all__ = ('DFL', 'HGBlock', 'HGStem', 'SPP', 'SPPF', 'C1', 'C2', 'C3', 'C2f', 'C3x', 'C3TR', 'C3Ghost',
           'GhostBottleneck', 'Bottleneck', 'BottleneckCSP', 'Proto', 'RepC3', 'ResNetLayer', 'TransPixelToken', 'CCTB')
...
class TransformerLayer(nn.Module):
    def __init__(self, c, num_heads):
        ...
        self.attention = nn.MultiheadAttention(embed_dim=c, num_heads=num_heads)
...
class TransPixelToken(C3):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        ...
        c_ = int(c2 * e)
        self.m = TransformerBlock(c_, c_, 4, n)
    # def __init__(self, c1, c2, num_heads=2, num_layers=4):
    #     super().__init__()
    #
    #     self.conv = None
    #     if c1 != c2:
    ...
    #     self.transformers = nn.ModuleList([TransformerLayer(c2, num_heads) for _ in range(num_layers)])
    #     self.c2 = c2
    #
    # def forward(self, x):
    ...
    #         p = transformer(p)
    #
    #     return p.view(b, w, h, self.c2).transpose(2, 3).transpose(1, 2)
...
class DaBlock(nn.Module):
    def __init__(self, inp, oup, reduction=64):
